    ...
    search(query) {
        ...
        switch (this.apiType) {
            ...
            case 'agents':
                ...
                break;
            case 'drivers':
                url = `/tls-ci4/safety/driver-maintenance/autocomplete?term=${encodeURIComponent(query)}`;
                break;
            case 'owners':
                url = `/tls-ci4/safety/owner-maintenance/autocomplete?term=${encodeURIComponent(query)}`;
                break;
            default:
